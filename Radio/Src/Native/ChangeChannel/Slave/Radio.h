...
#define SLEEPTEST 3
#define CHANGECHANNEL 4
#define CHANGEPOWER  5
...
//--//
	...
	BOOL 	 ChangeChannelTest_Reciever();

	BOOL     ChangeTxPowerTest_Reciever();
...
UINT8 RadioTest::channel = 0;
BOOL RadioTest::respond = FALSE;
