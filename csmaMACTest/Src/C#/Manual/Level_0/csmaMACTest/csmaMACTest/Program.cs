...
namespace Samraksh.SPOT.Test
{
    ...
    public class csmaMACTest
    {
        ...
        //Samraksh.SPOT.Net.MACBase csmaObject = new Net.MACBase(MacID.CSMA);
        ...
        void Level_0()
        {
            ...
            while (run.IsTrue())
            {
                ...
                Debug.Print("Broadcasting message");
        ...
        void HandleMessage(ushort NumberOfPacketsReceived)
        {
