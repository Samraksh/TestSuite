...
if(($accuracy * 100) -gt $acceptedAccuracy && $totalSamples -gt 100)
{
	$result = "FAIL"
}
else
...
{
"resultParameter1=Test failed because of low accuracy or insufficient test samples" | Out-File -FilePath $resultFile -Append
}
