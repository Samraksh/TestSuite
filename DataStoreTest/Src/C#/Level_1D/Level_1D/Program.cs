        ...
        public void Level_1D()
        {
            try
            {
                for (; dataIndex < experimentIndex; ++dataIndex)
                {
                    ...
                    {
                        DisplayStats(false, "Read not successful - test Level_1D failed", "", 0);
                        return;
                    }
                    ...
                    for (UInt16 rwIndex = 0; rwIndex < numData; ++rwIndex)
                    {
                        ...
                        {
                            DisplayStats(false, "Read Write test failed - test Level_1D failed", "", 0);
                            return;
                        }
                    }
                ...
                DisplayStats(true, "Test Level_1D successfully completed", "", 0);
            }
            catch (Exception ex)
            {
                ...
                if (errorCounter > errorLimit)
                {
                    DisplayStats(false, "Test Level_1D failed", "", 0);
                    return;
                }
                else
                {
