    ...
    public class DataStoreTest
    {
        ...
        public DataStoreTest()
        {
            ...
            catch (Exception ex)
            {
                ...
                DisplayStats(false, "Test Level_4B failed", "", 0);
                return;
            }
        }
            ...
            try
            {
                ...
                for (; dataIndex < experimentIndex; ++dataIndex)
                {
                    ...
                    if (data.Write(writeBuffer, 0, writeBuffer.Length) != DataStoreReturnStatus.Success)
                    {
                        ...
                        {
                            DisplayStats(false, "Data write failure - test Level_4B failed", "", 0);
                            return;
                        }
                        else
                        {
        ...
        public void TestPersistence()
        {
            try
            {
                ...
                while (offset < totalRecords)
                {
                    ...
                    {
                        DisplayStats(false, "ReadAllDataReferences - test Level_4B failed", "", 0);
                        return;
                    }
                    ...
                    while (dataIndex < dataAllocationIndex)
                    {
                        ...
                        {
                            DisplayStats(false, "Read not successful - test Level_4B failed", "", 0);
                            return;
                        }
                        ...
                        for (UInt16 rwIndex = 0; rwIndex < readBuffer.Length; ++rwIndex)
                        {
                            ...
                            {
                                DisplayStats(false, "Read Write test failed - test Level_4B failed", "", 0);
                                return;
                            }
                        }
                ...
                DisplayStats(true, "Test Level_4B successfully completed", "", 0);
            }
            catch (Exception ex)
            {
                Debug.Print(ex.Message);
