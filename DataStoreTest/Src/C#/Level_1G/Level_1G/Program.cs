            ...
            try
            {
                for (; dataIndex < experimentIndex; ++dataIndex)
                {
                    ...
                    if (data.Write(writeBuffer, offset, numData) != DataStoreReturnStatus.Success)
                    {
                        ...
                        {
                            DisplayStats(false, "Data write failure - test Level_1G failed", "", 0);
                            return;
                        }
                        else
                        {
                    ...
                    {
                        DisplayStats(false, "Read not successful - test Level_1G failed", "", 0);
                        return;
                    }
                    ...
                    for (UInt16 rwIndex = 0; rwIndex < numData; ++rwIndex)
                    {
                        ...
                        {
                            DisplayStats(false, "Read Write test failed - test Level_1G failed", "", 0);
                            return;
                        }
                    }
                ...
                DisplayStats(true, "Test Level_1G successfully completed", "", 0);
            }
            catch (Exception ex)
            {
                ...
                if (errorCounter > errorLimit)
                {
                    DisplayStats(false, "Test Level_1G failed", "", 0);
                    return;
                }
                else
                {
