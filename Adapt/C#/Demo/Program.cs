        ...
        public static void Main()
        {
			...
			while (true){
				try {
					...
					} else if ( ((xVal <10000)||(xVal>55000)) && ((yVal>40000)&&(yVal<60000)) ){
						// rot 270 
						if (rot != 270)
						{
							rot = 270;
					...
					} else if ( ((xVal>10000)&&(xVal<20000)) && ((yVal <10000)||(yVal>55000)) ){
						// rot 0 
						if (rot != 0)
						{
							rot = 0;
					...
					} else if ( ((xVal>40000)&&(xVal<60000)) && ((yVal <10000)||(yVal>55000)) ){
						// rot 180 
						if (rot != 180)
						{
							rot = 180;
					...
					if (drawImage == 1){
						...
						//	LCD.DrawImage(0,0,rotated,0,0,200,142,0xFF);
						} else if  (rot == 270){
							rotated.RotateImage(rot, 0, 0, image, 0, 0, 200, 200, 0xff);
