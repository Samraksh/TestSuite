...
namespace TestSuite
{
	...
	private static InterruptPort testPort_PB15 = new InterruptPort(GPIOPins.GPIO_PIN_PB15, false, Port.ResistorMode.Disabled, Port.InterruptMode.InterruptEdgeLow);
