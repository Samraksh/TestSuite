...
namespace TestSuite
{
    ...
    private static Microsoft.SPOT.Hardware.InputPort testPort_PB15 = new Microsoft.SPOT.Hardware.InputPort(GPIOPins.GPIO_PIN_PB15, false, Port.ResistorMode.PullDown);
