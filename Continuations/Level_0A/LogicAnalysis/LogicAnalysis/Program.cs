...
namespace LogicAnalysis
{
    class Program
    {
        ...
        const float expectedFreq0 = 480.5f;
        const float expectedFreq1 = 480.5f;
        ...
        const double expectedMinTime0 = 0.0009;
        const double expectedMinTime1 = 0.0009;
        const double expectedMinTime2 = 0.399;
        const double expectedMinTime3 = 0.019f;

        const double expectedMaxTime0 = 0.003;
        const double expectedMaxTime1 = 0.003;
