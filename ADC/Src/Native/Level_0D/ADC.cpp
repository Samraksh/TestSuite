...
UINT16 adcBuffer1[1000];
UINT16 adcBuffer2[1000];
...
extern DeviceStatus AD_ConfigureBatchMode(UINT16* sampleBuff1, UINT32 numSamples, UINT32 samplingTime, HAL_CALLBACK_FPN userCallback, void* Param);
...
void Timer_1_Handler(void *arg)
{
	...
	AD_ConfigureBatchMode(adcBuffer, 1000, 1000, ADCUserHandler, NULL);
}
}
...
BOOL ADCTest::Level_0C()
{
	...
	gHalTimerManagerObject.CreateTimer(1, 0, 400000, FALSE, FALSE, Timer_1_Handler);
